...
Run the sbt task or npm script to merge files: `sbt oasMerge` or `npm run oasMerge`

Run the sbt task or npm script  merge files in verbose mode: `sbt oasMergeVerbose` or `npm run oasMerge`
