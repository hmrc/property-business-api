...
case class ResolveParsedNumber(min: BigDecimal = 0, max: BigDecimal = 99999999999.99, disallowZero: Boolean = false) extends Resolvers {

  def resolver(error: => MtdError): SimpleResolver[BigDecimal, BigDecimal] = { value =>
