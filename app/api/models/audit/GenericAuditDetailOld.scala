...
case class GenericAuditDetailOld(versionNumber: String,
                                 userType: String,
...
object GenericAuditDetailOld {
  ...
  def apply[A: OWrites](userDetails: UserDetails,
                        ...
                        correlationId: String,
                        response: AuditResponse,
                        versionNumber: String = "2.0"): GenericAuditDetailOld = {
  ...
  def auditDetailCreator(params: Map[String, String]): AuditHandlerOld.AuditDetailCreatorOld[GenericAuditDetailOld] =
    new AuditHandlerOld.AuditDetailCreatorOld[GenericAuditDetailOld] {
