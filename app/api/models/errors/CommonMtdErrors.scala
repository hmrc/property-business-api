...
// Rule Errors
object RuleIncorrectOrEmptyBodyError extends MtdError("RULE_INCORRECT_OR_EMPTY_BODY_SUBMITTED", "An empty or non-matching body was submitted", BAD_REQUEST)
...
object RuleToDateBeforeFromDateError extends MtdError("RULE_TO_DATE_BEFORE_FROM_DATE", "The To date cannot be earlier than the From date", BAD_REQUEST)
...
object RuleOverlappingPeriodError extends MtdError("RULE_OVERLAPPING_PERIOD", "Period summary overlaps with any of the existing period summaries", BAD_REQUEST)
...
object RuleDuplicateSubmissionError extends MtdError("RULE_DUPLICATE_SUBMISSION", "A summary has already been submitted for the period specified", BAD_REQUEST)

object RuleTypeOfBusinessIncorrectError extends MtdError("RULE_TYPE_OF_BUSINESS_INCORRECT", "The businessId is for a different type of business", BAD_REQUEST)
...
object RuleTaxYearNotSupportedError extends MtdError("RULE_TAX_YEAR_NOT_SUPPORTED", "The tax year specified does not lie within the supported range", BAD_REQUEST)
...
object RulePropertyIncomeAllowanceError
    extends MtdError("RULE_PROPERTY_INCOME_ALLOWANCE", "The propertyIncomeAllowance cannot be submitted if privateUseAdjustment is supplied", BAD_REQUEST)
...
object RuleInvalidSubmissionPeriodError
    extends MtdError("RULE_INVALID_SUBMISSION_PERIOD",
                     "Property income and expenses submissions cannot be more than 10 days before the end of the Period", BAD_REQUEST)

object RuleInvalidSubmissionEndDateError extends MtdError("RULE_INVALID_SUBMISSION_END_DATE", "The submitted end date must be the end of the quarter", BAD_REQUEST)
...
//Stub errors
object RuleIncorrectGovTestScenarioError extends MtdError(code = "RULE_INCORRECT_GOV_TEST_SCENARIO", message = "The Gov-Test-Scenario was not found", NOT_FOUND)
