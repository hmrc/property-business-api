...
object FromDateFormatError      extends MtdError("FORMAT_FROM_DATE", "The provided From date is invalid or before 1900", BAD_REQUEST)
object ToDateFormatError        extends MtdError("FORMAT_TO_DATE", "The provided To date is invalid or after 2100", BAD_REQUEST)
