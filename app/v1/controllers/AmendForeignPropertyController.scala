...
@Singleton
class AmendForeignPropertyController  @Inject()(val authService: EnrolmentsAuthService,
                                                val lookupService: MtdIdLookupService,
                                                parser: AmendForeignPropertyRequestParser,
                                                service: AmendForeignPropertyService,
