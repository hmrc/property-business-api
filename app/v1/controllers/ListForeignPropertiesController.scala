...
@Singleton
class ListForeignPropertiesController  @Inject()(val authService: EnrolmentsAuthService,
                                                 val lookupService: MtdIdLookupService,
                                                 parser: ListForeignPropertiesRequestParser,
                                                 service: ListForeignPropertiesService,
