...
import v1.connectors.CreateForeignPropertyConnector
...
@Singleton
class CreateForeignPropertyService @Inject()(connector: CreateForeignPropertyConnector) extends DesResponseMappingSupport with Logging {

  def createForeignProperty(request: CreateForeignPropertyRequestData)(
    implicit hc: HeaderCarrier,
    ec: ExecutionContext,
    logContext: EndpointLogContext): Future[CreateForeignPropertyServiceOutcome] = {
