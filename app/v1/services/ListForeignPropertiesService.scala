...
import v1.connectors.ListForeignPropertiesConnector
...
@Singleton
class ListForeignPropertiesService @Inject()(connector: ListForeignPropertiesConnector) extends DesResponseMappingSupport with Logging {

  def listForeignProperties(request: ListForeignPropertiesRequest)(
    implicit hc: HeaderCarrier,
    ec: ExecutionContext,
    logContext: EndpointLogContext): Future[ListForeignPropertiesServiceOutcome] = {
