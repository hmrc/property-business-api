...
import v2.controllers.validators.RetrieveHistoricFhlUkPropertyAnnualSubmissionValidatorFactory
...
@Singleton
class RetrieveHistoricFhlUkPropertyAnnualSubmissionController @Inject() (
