...
object RuleBuildingNameNumber extends MtdError("RULE_BUILDING_NAME_NUMBER", "Postcode must be supplied along with at least one of name or number")
...
object RuleDuplicateSubmission       extends MtdError("RULE_DUPLICATE_SUBMISSION", "A summary has already been submitted for the period specified")
object RuleTypeOfBusinessIncorrect   extends MtdError("RULE_TYPE_OF_BUSINESS_INCORRECT", "The businessId is for a different type of business")
