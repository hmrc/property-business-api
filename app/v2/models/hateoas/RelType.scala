...
object RelType {
  ...
  val AMEND_HISTORIC_UK_FHL_PROPERTY_PERIOD_SUMMARY    = "amend-uk-property-historic-fhl-period-summary"
  val LIST_HISTORIC_UK_FHL_PROPERTY_PERIOD_SUMMARIES   = "list-uk-property-historic-fhl-period-summaries"
