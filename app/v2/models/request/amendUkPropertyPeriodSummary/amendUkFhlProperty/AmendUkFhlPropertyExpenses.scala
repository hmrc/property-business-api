...
case class AmendUkFhlPropertyExpenses(premisesRunningCosts: Option[BigDecimal],
...
object AmendUkFhlPropertyExpenses {
  implicit val reads: Reads[AmendUkFhlPropertyExpenses] = Json.reads[AmendUkFhlPropertyExpenses]

  implicit val writes: Writes[AmendUkFhlPropertyExpenses] = (
  ...
  )(unlift(AmendUkFhlPropertyExpenses.unapply))
}
