...
case class AmendUkNonFhlPropertyExpenses(premisesRunningCosts: Option[BigDecimal],
...
object AmendUkNonFhlPropertyExpenses {
  implicit val reads: Reads[AmendUkNonFhlPropertyExpenses] = Json.reads[AmendUkNonFhlPropertyExpenses]

  implicit val writes: Writes[AmendUkNonFhlPropertyExpenses] = (
  ...
  )(unlift(AmendUkNonFhlPropertyExpenses.unapply _))
}
