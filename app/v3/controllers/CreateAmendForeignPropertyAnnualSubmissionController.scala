...
import v3.controllers.validators.CreateAmendForeignPropertyAnnualSubmissionValidatorFactory
...
import v3.models.response.createAmendForeignPropertyAnnualSubmission.CreateAmendForeignPropertyAnnualSubmissionResponse._
import v3.services.CreateAmendForeignPropertyAnnualSubmissionService

import javax.inject.{Inject, Singleton}
import scala.concurrent.ExecutionContext

@Singleton
class CreateAmendForeignPropertyAnnualSubmissionController @Inject() (
