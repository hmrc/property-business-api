...
import v4.controllers.amendForeignPropertyPeriodSummary.def1.model.request.foreignFhlEea.{AmendForeignFhlEea, AmendForeignFhlEeaExpenses}
import v4.controllers.amendForeignPropertyPeriodSummary.def1.model.request.foreignPropertyEntry.{AmendForeignNonFhlPropertyEntry, AmendForeignNonFhlPropertyExpenses}
import v4.controllers.amendForeignPropertyPeriodSummary.model.request.Def1_AmendForeignPropertyPeriodSummaryRequestData
