...
package v4.controllers.amendForeignPropertyPeriodSummary.def2
...
import v4.controllers.amendForeignPropertyPeriodSummary.def2.model.request.def2_foreignFhlEea.{
  Def2_AmendForeignFhlEea,
  Def2_AmendForeignFhlEeaExpenses
}
import v4.controllers.amendForeignPropertyPeriodSummary.def2.model.request.def2_foreignPropertyEntry.{
  Def2_AmendForeignNonFhlPropertyEntry,
  Def2_AmendForeignNonFhlPropertyExpenses
}
import v4.controllers.amendForeignPropertyPeriodSummary.model.request.Def2_AmendForeignPropertyPeriodSummaryRequestData
    ...
    foreignNonFhlPropertyEntry.expenses
      .map { expenses =>
        expenses.consolidatedExpenses match {
          ...
          case Some(_) =>
            expenses match {
              case Def2_AmendForeignNonFhlPropertyExpenses(None, None, None, None, None, None, None, None, None, Some(_)) => valid
