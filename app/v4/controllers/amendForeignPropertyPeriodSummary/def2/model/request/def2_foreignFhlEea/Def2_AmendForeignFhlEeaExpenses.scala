...
case class Def2_AmendForeignFhlEeaExpenses(
...
object Def2_AmendForeignFhlEeaExpenses {
  implicit val reads: Reads[Def2_AmendForeignFhlEeaExpenses] = Json.reads[Def2_AmendForeignFhlEeaExpenses]

  implicit val writes: Writes[Def2_AmendForeignFhlEeaExpenses] = (
  ...
  )(unlift(Def2_AmendForeignFhlEeaExpenses.unapply))
