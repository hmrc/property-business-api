...
object Def2_Amend_UkFhlPropertyExpenses {
  ...
  implicit val writes: Writes[Def2_Amend_UkFhlPropertyExpenses] = (
    (JsPath \ "premisesRunningCosts").writeNullable[BigDecimal] and
      ...
      (JsPath \ "ukFhlRentARoom").writeNullable[Def2_Amend_UkPropertyExpensesRentARoom]
  )(unlift(Def2_Amend_UkFhlPropertyExpenses.unapply))
