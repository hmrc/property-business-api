...
package v4.controllers.createAmendUkPropertyAnnualSubmission.model.request

import play.api.libs.functional.syntax._
import play.api.libs.json.{JsPath, Json, OWrites, Reads}
import v4.controllers.createAmendUkPropertyAnnualSubmission.def1.model.request.def1_ukFhlProperty.Def1_Create_Amend_UkFhlProperty
import v4.controllers.createAmendUkPropertyAnnualSubmission.def1.model.request.def1_ukNonFhlProperty.Def1_Create_Amend_UkNonFhlProperty

sealed trait CreateAmendUkPropertyAnnualSubmissionRequestBody
