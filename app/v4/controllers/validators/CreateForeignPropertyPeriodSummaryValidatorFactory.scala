...
import v4.controllers.validators.CreateForeignPropertyPeriodSummaryRulesValidator.validateBusinessRules
import v4.models.request.createForeignPropertyPeriodSummary.{CreateForeignPropertyPeriodSummaryRequestBody, CreateForeignPropertyPeriodSummaryRequestData}
    ...
    new Validator[CreateForeignPropertyPeriodSummaryRequestData] {
      ...
      def validate: Validated[Seq[MtdError], CreateForeignPropertyPeriodSummaryRequestData] =
        (
          ...
          resolveJson(body)
        ).mapN(CreateForeignPropertyPeriodSummaryRequestData) andThen validateBusinessRules
