...
case class Def1_Create_Amend_UkNonFhlProperty(adjustments: Option[Def1_Create_Amend_UkNonFhlPropertyAdjustments],
                                              allowances: Option[Def1_Create_Amend_UkNonFhlPropertyAllowances])

object Def1_Create_Amend_UkNonFhlProperty {
  implicit val reads: Reads[Def1_Create_Amend_UkNonFhlProperty] = Json.reads[Def1_Create_Amend_UkNonFhlProperty]
