...
import v4.createForeignPropertyPeriodSummary.def1.model.request.foreignFhlEea.{CreateForeignFhlEea, CreateForeignFhlEeaExpenses}
import v4.createForeignPropertyPeriodSummary.def1.model.request.foreignPropertyEntry.{CreateForeignNonFhlPropertyEntry, CreateForeignNonFhlPropertyExpenses}
