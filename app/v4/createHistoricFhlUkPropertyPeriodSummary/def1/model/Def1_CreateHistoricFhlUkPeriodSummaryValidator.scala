...
package v4.createHistoricFhlUkPropertyPeriodSummary.def1.model
...
import v4.createHistoricFhlUkPropertyPeriodSummary.model.request._


class Def1_CreateHistoricFhlUkPeriodSummaryValidator(nino: String, body: JsValue, appConfig: AppConfig)
  extends Validator[CreateHistoricFhlUkPiePeriodSummaryRequestData] {
  ...
  def validate: Validated[Seq[MtdError], CreateHistoricFhlUkPiePeriodSummaryRequestData] =
    (
      ResolveNino(nino),
      resolveJson(body)
      ).mapN(Def1_CreateHistoricFhlUkPiePeriodSummaryRequestData) andThen validateBusinessRules

  private def validateBusinessRules(
                                     parsed: Def1_CreateHistoricFhlUkPiePeriodSummaryRequestData): Validated[Seq[MtdError], CreateHistoricFhlUkPiePeriodSummaryRequestData] = {
