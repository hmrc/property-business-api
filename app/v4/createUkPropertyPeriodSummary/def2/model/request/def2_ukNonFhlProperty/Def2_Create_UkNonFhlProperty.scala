...
case class Def2_Create_UkNonFhlPropertySubmission(income: Option[Def2_Create_UkNonFhlPropertyIncome],
                                                  expenses: Option[Def2_Create_UkNonFhlPropertyExpensesSubmission])
