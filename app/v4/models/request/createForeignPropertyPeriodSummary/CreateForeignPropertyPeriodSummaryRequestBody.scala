...
package v4.models.request.createForeignPropertyPeriodSummary

import play.api.libs.functional.syntax._
import play.api.libs.json.{JsPath, Json, OWrites, Reads}
import shapeless.HNil
import utils.EmptinessChecker
import v4.models.request.createForeignPropertyPeriodSummary.foreignFhlEea.CreateForeignFhlEea
import v4.models.request.createForeignPropertyPeriodSummary.foreignPropertyEntry.CreateForeignNonFhlPropertyEntry
...
object CreateForeignPropertyPeriodSummaryRequestBody {
  ...
  implicit val writes: OWrites[CreateForeignPropertyPeriodSummaryRequestBody] = (
    (JsPath \ "fromDate").write[String] and
      ...
      (JsPath \ "foreignFhlEea").writeNullable[foreignFhlEea.CreateForeignFhlEea] and
      (JsPath \ "foreignProperty").writeNullable[Seq[foreignPropertyEntry.CreateForeignNonFhlPropertyEntry]]
