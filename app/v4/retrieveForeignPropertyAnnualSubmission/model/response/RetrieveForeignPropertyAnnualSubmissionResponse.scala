...
import v4.retrieveForeignPropertyAnnualSubmission.model.response.Def1_RetrieveForeignPropertyAnnualSubmissionResponse.Def1_RetrieveForeignAnnualSubmissionLinksFactory
