...
import v4.retrieveHistoricFhlUkPropertyPeriodSummary.model.response._
...
class RetrieveHistoricFhlUkPropertyPeriodSummaryConnector @Inject()(val http: HttpClient, val appConfig: AppConfig)
  ...
  def retrieve(request: RetrieveHistoricFhlUkPiePeriodSummaryRequestData)(implicit
    ...
    request match {
      case def1: Def1_RetrieveHistoricFhlUkPiePeriodSummaryRequestData =>
        import def1._

        val downstreamUri = DesUri[Def1_RetrieveHistoricFhlUkPiePeriodSummaryResponse](
