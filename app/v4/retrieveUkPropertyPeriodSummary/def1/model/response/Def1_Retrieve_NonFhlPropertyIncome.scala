...
object Def1_Retrieve_NonFhlPropertyIncome {
  implicit val writes: OWrites[Def1_Retrieve_NonFhlPropertyIncome] = Json.writes[Def1_Retrieve_NonFhlPropertyIncome]

  implicit val reads: Reads[Def1_Retrieve_NonFhlPropertyIncome] = (
