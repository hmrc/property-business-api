...
import v5.amendForeignPropertyPeriodSummary.def1.model.request.foreignFhlEea.{AmendForeignFhlEea, AmendForeignFhlEeaExpenses}
...
import v5.amendForeignPropertyPeriodSummary.model.request.Def1_AmendForeignPropertyPeriodSummaryRequestData
