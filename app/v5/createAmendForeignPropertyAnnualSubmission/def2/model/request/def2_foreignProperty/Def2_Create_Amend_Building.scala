...
object Def2_Create_Amend_Building {
  implicit val reads: Reads[Def2_Create_Amend_Building] = Json.reads[Def2_Create_Amend_Building]

  implicit val writes: Writes[Def2_Create_Amend_Building] = (
