...
object Def1_CreateForeignPropertyPeriodCumulativeSummaryRequestBody {
  ...
  implicit val format: OFormat[Def1_CreateForeignPropertyPeriodCumulativeSummaryRequestBody] =
    Json.format[Def1_CreateForeignPropertyPeriodCumulativeSummaryRequestBody]
