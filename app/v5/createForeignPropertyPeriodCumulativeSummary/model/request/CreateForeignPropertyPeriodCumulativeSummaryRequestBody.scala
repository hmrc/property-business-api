...
import v5.createForeignPropertyPeriodCumulativeSummary.def1.model.request.Def1_foreignFhlEea.Def1_Create_CreateForeignFhlEea
import v5.createForeignPropertyPeriodCumulativeSummary.def1.model.request.Def1_foreignPropertyEntry.Def1_Create_CreateForeignNonFhlPropertyEntry
...
object Def1_CreateForeignPropertyPeriodCumulativeSummaryRequestBody {
  ...
  implicit val reads: Reads[Def1_CreateForeignPropertyPeriodCumulativeSummaryRequestBody] = Json.reads[Def1_CreateForeignPropertyPeriodCumulativeSummaryRequestBody]
