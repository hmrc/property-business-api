...
import v5.createForeignPropertyPeriodSummary.def2.model.request.Def2_foreignPropertyEntry.{
  Def2_Create_CreateForeignNonFhlPropertyEntry,
  Def2_Create_CreateForeignNonFhlPropertyExpenses
}
import v5.createForeignPropertyPeriodSummary.model.request.Def2_CreateForeignPropertyPeriodSummaryRequestData
