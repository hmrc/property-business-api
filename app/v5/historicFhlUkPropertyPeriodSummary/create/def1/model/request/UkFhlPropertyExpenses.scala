...
package v5.historicFhlUkPropertyPeriodSummary.create.def1.model.request

import play.api.libs.functional.syntax.{toFunctionalBuilderOps, unlift}
import play.api.libs.json.{JsPath, Json, Reads, Writes}
import v5.createAmendHistoricNonFhlUkPropertyAnnualSubmission.def1.model.request.UkPropertyExpensesRentARoom
...
object UkFhlPropertyExpenses {
  implicit val mtdReads: Reads[UkFhlPropertyExpenses] = Json.reads[UkFhlPropertyExpenses]

  implicit val downstreamWrites: Writes[UkFhlPropertyExpenses] = (
