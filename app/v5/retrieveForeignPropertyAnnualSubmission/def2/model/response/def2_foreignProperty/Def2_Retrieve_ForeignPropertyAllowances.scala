...
case class Def2_Retrieve_ForeignPropertyAllowances(annualInvestmentAllowance: Option[BigDecimal],
...
object Def2_Retrieve_ForeignPropertyAllowances {
  implicit val writes: OWrites[Def2_Retrieve_ForeignPropertyAllowances] = Json.writes[Def2_Retrieve_ForeignPropertyAllowances]

  implicit val reads: Reads[Def2_Retrieve_ForeignPropertyAllowances] = (
  ...
  )(Def2_Retrieve_ForeignPropertyAllowances.apply _)
