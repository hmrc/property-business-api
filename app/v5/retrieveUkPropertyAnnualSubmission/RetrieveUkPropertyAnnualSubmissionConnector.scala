...
import v5.retrieveUkPropertyAnnualSubmission.model.response.{Def1_RetrieveUkPropertyAnnualSubmissionResponse, Def2_RetrieveUkPropertyAnnualSubmissionResponse}
