...
package v6.amendUkPropertyPeriodSummary.def1.model.request.def1_ukNonFhlProperty

import play.api.libs.functional.syntax._
import play.api.libs.json.{JsPath, Json, Reads, Writes}
import v6.amendUkPropertyPeriodSummary.def1.model.request.def1_ukPropertyRentARoom.Def1_Amend_UkPropertyExpensesRentARoom

case class Def1_Amend_UkNonFhlPropertyExpenses(premisesRunningCosts: Option[BigDecimal],
...
object Def1_Amend_UkNonFhlPropertyExpenses {
  implicit val reads: Reads[Def1_Amend_UkNonFhlPropertyExpenses] = Json.reads[Def1_Amend_UkNonFhlPropertyExpenses]

  implicit val writes: Writes[Def1_Amend_UkNonFhlPropertyExpenses] = (
