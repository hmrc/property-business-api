...
case class Def3_CreateAmendForeignPropertyAnnualSubmissionRequestData(nino: Nino,
  ...
  override val schema: CreateAmendForeignPropertyAnnualSubmissionSchema = CreateAmendForeignPropertyAnnualSubmissionSchema.Def3
}
