...
case class Def1_Create_CreateForeignNonFhlPropertyExpenses(premisesRunningCosts: Option[BigDecimal],
...
object Def1_Create_CreateForeignNonFhlPropertyExpenses {
  implicit val reads: Reads[Def1_Create_CreateForeignNonFhlPropertyExpenses] = Json.reads[Def1_Create_CreateForeignNonFhlPropertyExpenses]

  implicit val writes: Writes[Def1_Create_CreateForeignNonFhlPropertyExpenses] = (
  ...
  )(unlift(Def1_Create_CreateForeignNonFhlPropertyExpenses.unapply))
