...
package v6.historicFhlUkPropertyPeriodSummary.create.def1.model.request

import play.api.libs.functional.syntax.{toFunctionalBuilderOps, unlift}
import play.api.libs.json.{JsPath, Json, Reads, Writes}
import v6.createAmendHistoricNonFhlUkPropertyAnnualSubmission.def1.model.request.UkPropertyIncomeRentARoom
...
object UkFhlPropertyIncome {
  ...
  implicit val mtdReads: Reads[UkFhlPropertyIncome] = Json.reads

  implicit val downstreamWrites: Writes[UkFhlPropertyIncome] = (
