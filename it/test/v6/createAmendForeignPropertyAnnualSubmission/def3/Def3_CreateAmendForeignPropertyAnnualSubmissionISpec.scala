...
class Def3_CreateAmendForeignPropertyAnnualSubmissionISpec extends IntegrationBaseSpec with Def3_Fixtures {
    ...
    "validation error occurs" when {
      ...
      val input = List(
        ...
        (
          ...
          "XAIS12345678910",
          "2026-27",
          Json.obj("foreignProperty" -> JsArray(Seq.fill(2)(def3_foreignEntryMtdJson))),
          BAD_REQUEST,
