...
class Def3_CreateAmendUkPropertyAnnualSubmissionISpec extends IntegrationBaseSpec {
  ...
  "Calling the amend uk property annual submission endpoint" should {
    ...
    "return a 400 with multiple errors" when {
      "all field validations fail on the request body" in new Test {
        ...
        val allInvalidFieldsRequestBodyJson: JsValue = Json.parse("""
            ...
            |      "zeroEmissionsGoodsVehicleAllowance": 2000.678900,
            ...
            |      "zeroEmissionsCarAllowance": 3000.83456780,
            |      "firstYearAllowanceOnPlantAndMachinery": 3000.95678900,
            |      "structuredBuildingAllowance": [
            |        {
            |          "amount": 3000.36780,
            |          "firstYear": {
    ...
    "return an error according to spec" when {
      ...
      val allInvalidValueRequestBodyJson = Json.parse("""
          ...
          |      "zeroEmissionsCarAllowance": 3000.834560,
          |      "firstYearAllowanceOnPlantAndMachinery": 3000.956430,
          |      "structuredBuildingAllowance": [
          |        {
          |          "amount": 3000.303645,
          |          "firstYear": {
      ...
      "validation error occurs" when {
        ...
        val input = List(
          ("AA1123A", "XAIS12345678910", "2026-27", validRequestBodyJson, BAD_REQUEST, NinoFormatError),
          ("AA123456A", "XAIS12345678910", "202362-23", validRequestBodyJson, BAD_REQUEST, TaxYearFormatError),
          ("AA123456A", "XAIS1234dfxgchjbn5678910", "2026-27", validRequestBodyJson, BAD_REQUEST, BusinessIdFormatError),
          ("AA123456A", "XAIS12345678910", "2026-29", validRequestBodyJson, BAD_REQUEST, RuleTaxYearRangeInvalidError),
          ("AA123456A", "XAIS12345678910", "2026-27", Json.parse(s"""{}""".stripMargin), BAD_REQUEST, RuleIncorrectOrEmptyBodyError),
          ("AA123456A", "XAIS12345678910", "2026-27", allInvalidValueRequestBodyJson, BAD_REQUEST, allInvalidValueRequestError),
          ("AA123456A", "XAIS12345678910", "2026-27", allInvalidDateFormatRequestBodyJson, BAD_REQUEST, allInvalidDateFormatRequestError),
          ("AA123456A", "XAIS12345678910", "2026-27", allInvalidStringRequestBodyJson, BAD_REQUEST, allInvalidStringRequestError),
          ("AA123456A", "XAIS12345678910", "2026-27", buildingNameNumberBodyJson, BAD_REQUEST, buildingNameNumberError),
          ("AA123456A", "XAIS12345678910", "2026-27", bothAllowancesSuppliedBodyJson, BAD_REQUEST, bothAllowancesSuppliedError)
        )
