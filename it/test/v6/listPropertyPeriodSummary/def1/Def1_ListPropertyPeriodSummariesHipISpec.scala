...
class Def1_ListPropertyPeriodSummariesHipISpec extends IntegrationBaseSpec {

  override def servicesConfig: Map[String, Any] =
    Map("feature-switch.ifs_hip_migration_1954.enabled" -> true) ++ super.servicesConfig
  ...
  private trait HipTest extends Test {
    ...
    def downstreamUri: String = s"/itsa/income-tax/v1/23-24/business/property/periodic/$nino/$businessId/submissions"
