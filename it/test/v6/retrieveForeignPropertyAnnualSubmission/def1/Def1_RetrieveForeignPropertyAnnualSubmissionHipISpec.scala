...
class Def1_RetrieveForeignPropertyAnnualSubmissionHipISpec extends IntegrationBaseSpec {
    ...
    "return error according to spec" when {
      ...
      "validation error" when {
        ...
        val input = List(
          ...
          ("AA123456A", "203100", "2024-25", Status.BAD_REQUEST, BusinessIdFormatError),
