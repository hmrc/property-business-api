...
package v6.retrieveForeignPropertyCumulativeSummaryISpec.def2
...
class Def2_RetrieveForeignPropertyCumulativeSummaryHipISpec extends IntegrationBaseSpec with Def2_RetrieveForeignPropertyCumulativeSummaryFixture {
