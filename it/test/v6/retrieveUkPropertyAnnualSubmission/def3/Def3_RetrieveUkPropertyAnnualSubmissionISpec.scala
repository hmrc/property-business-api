...
package v6.retrieveUkPropertyAnnualSubmission.def3
...
class Def3_RetrieveUkPropertyAnnualSubmissionISpec extends IntegrationBaseSpec {

  "calling the retrieve uk property annual submission HIP endpoint" should {
  ...
  private trait Test {
    ...
    def downstreamUri: String = s"/itsa/income-tax/v1/26-27/business/property/annual/$nino/$businessId"
