...
class RetrieveForeignPropertyControllerISpec extends IntegrationBaseSpec {
  ...
  "calling the retrieve endpoint" should {
    ...
    "return error according to spec" when {
      ...
      "validation error" when {
        def validationErrorTest(requestNino: String, requestBusinessId: String, requestSubmissionId: String, expectedStatus: Int, expectedBody: MtdError): Unit = {
