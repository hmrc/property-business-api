...
class ListHistoricNonFhlUkPropertyPeriodSummariesControllerISpec extends IntegrationBaseSpec {
  ...
  private trait Test {
    ...
    val responseBody: JsValue = Json.parse(
      s"""{
         ...
         |         "links": [
         |           {
         |             "href": "/individuals/business/property/uk/period/non-furnished-holiday-lettings/$nino/$periodId",
         |             "method": "PUT",
         ...
         |  "links": [
         |    {
         |      "href": "/individuals/business/property/uk/period/non-furnished-holiday-lettings/$nino",
         |      "method": "GET",
         |      "rel": "self"
         |    },
         |    {
         |      "href": "/individuals/business/property/uk/period/non-furnished-holiday-lettings/$nino",
         |      "method": "POST",
         |      "rel": "create-uk-property-historic-non-fhl-period-summary"
         |    }
         |  ]
         |}
       """.stripMargin
    ...
    def request(): WSRequest = {
      setupStubs()
      buildRequest(s"/uk/period/non-furnished-holiday-lettings/$nino")
        .withHttpHeaders(
  ...
  "List Historic Non-FHL UK Property Period Summaries endpoint" should {
    ...
    "return ifs service error" when {
      ...
      val input = Seq(
        ...
        (Status.UNPROCESSABLE_ENTITY, "TAX_YEAR_NOT_SUPPORTED", Status.INTERNAL_SERVER_ERROR, InternalError),
