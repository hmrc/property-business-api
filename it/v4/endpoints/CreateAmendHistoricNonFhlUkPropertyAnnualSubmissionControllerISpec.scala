...
import v4.stubs.{AuthStub, DownstreamStub, MtdIdLookupStub, AuditStub}
  ...
  private trait Test {
    ...
    val responseBody: JsValue = Json.parse(
      s"""
         ...
         |   "links":[
         |      {
         |         "href":"/individuals/business/property/uk/annual/non-furnished-holiday-lettings/AA999999A/2020-21",
         |         "method":"GET",
         |         "rel":"self"
         |      },
         |      {
