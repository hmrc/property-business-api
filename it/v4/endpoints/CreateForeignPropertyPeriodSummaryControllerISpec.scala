      ...
      "validation error" when {
        ...
        val input = List(
          ...
          (
            ...
            BAD_REQUEST,
            ValueFormatError.withPath("/foreignFhlEea/expenses/premisesRunningCosts")),
          (
            "AA123456A",
            "XAIS12345678910",
            "2022-23",
            ...
            BAD_REQUEST,
            RuleBothExpensesSuppliedError.withPath("/foreignFhlEea/expenses")),
          ...
          (
            ...
            BAD_REQUEST,
            CountryCodeFormatError.withPath("/foreignNonFhlProperty/0/countryCode")),
          (
            "AA123456A",
            "XAIS12345678910",
            "2022-23",
            ...
            BAD_REQUEST,
            RuleCountryCodeError.withPath("/foreignNonFhlProperty/0/countryCode")),
          (
            "AA123456A",
            "XAIS12345678910",
            "2022-23",
        ...
        def serviceErrorTest(downstreamStatus: Int, downstreamErrorCode: String, expectedStatus: Int, expectedBody: MtdError): Unit = {
          s"downstream returns an $downstreamErrorCode error and status $downstreamStatus" in new NonTysTest {
            ...
            override def setupStubs(): StubMapping = {
              ...
              AuthStub.authorised()
              MtdIdLookupStub.ninoFound(nino)
              DownstreamStub.onError(DownstreamStub.POST, downstreamUri, downstreamQueryParams, downstreamStatus, errorBody(downstreamErrorCode))
            }
