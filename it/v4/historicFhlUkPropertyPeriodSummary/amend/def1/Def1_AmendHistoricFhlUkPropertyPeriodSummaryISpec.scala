    ...
    "return a 200 status code" when {
      ...
      "any valid unconsolidated request is made" in new Test {
        override def setupStubs(): StubMapping = {
          ...
          DownstreamStub
            ...
            .withRequestBody(downstreamBody[Def1_AmendHistoricFhlUkPropertyPeriodSummaryRequestBody](requestBodyJson))
      ...
      "any valid consolidated request is made" in new Test {
        override def setupStubs(): StubMapping = {
          ...
          DownstreamStub
            .when(DownstreamStub.PUT, ifsUri, queryParams = ifsQueryParams)
            .withRequestBody(downstreamBody[Def1_AmendHistoricFhlUkPropertyPeriodSummaryRequestBody](requestBodyJsonConsolidatedExpenses))
            .thenReturn(OK, successDownstreamBody)
        }
