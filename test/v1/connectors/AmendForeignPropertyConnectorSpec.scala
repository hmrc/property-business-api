...
class AmendForeignPropertyConnectorSpec extends ConnectorSpec {
  ...
  class Test extends MockHttpClient with MockAppConfig {
    val connector: AmendForeignPropertyConnector = new AmendForeignPropertyConnector(http = mockHttpClient, appConfig = mockAppConfig)
