...
class ListForeignPropertiesConnectorSpec extends ConnectorSpec {
  ...
  class Test extends MockHttpClient with MockAppConfig {
    val connector: ListForeignPropertiesConnector = new ListForeignPropertiesConnector(http = mockHttpClient, appConfig = mockAppConfig)
