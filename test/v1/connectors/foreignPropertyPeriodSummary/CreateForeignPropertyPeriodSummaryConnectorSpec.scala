...
package v1.connectors.foreignPropertyPeriodSummary
...
class CreateForeignPropertyPeriodSummaryConnectorSpec extends ConnectorSpec {
  ...
  "connector" must {
    "put a body with regular expenses and return 200 with submissionId" in new Test {
      ...
      await(connector.createForeignPropertyPeriodSummary(regularExpensesRequestData)) shouldBe outcome
    ...
    "put a body with consolidated expenses and return 200 with submissionId" in new Test {
      ...
      await(connector.createForeignPropertyPeriodSummary(consolidatedExpensesRequestData)) shouldBe outcome
