...
import v1.mocks.requestParsers.MockCreateForeignPropertyRequestParser
import v1.mocks.services.{MockAuditService, MockCreateForeignPropertyService, MockEnrolmentsAuthService, MockMtdIdLookupService}
...
class CreateForeignPropertyControllerSpec
  extends ControllerBaseSpec
  with MockEnrolmentsAuthService
  with MockMtdIdLookupService
  with MockCreateForeignPropertyService
  with MockCreateForeignPropertyRequestParser
  ...
  trait Test {
    ...
    val controller = new CreateForeignPropertyController(
