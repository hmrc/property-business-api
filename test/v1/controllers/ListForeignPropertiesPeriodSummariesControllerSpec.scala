...
import v1.models.response.listForeignPropertiesPeriodSummaries.{ListForeignPropertiesHateoasData, ListForeignPropertiesPeriodSummariesResponse, SubmissionPeriod}
