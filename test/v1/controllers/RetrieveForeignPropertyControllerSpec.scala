...
import v1.mocks.requestParsers.MockRetrieveForeignPropertyRequestParser
import v1.mocks.services.{MockAuditService, MockEnrolmentsAuthService, MockMtdIdLookupService, MockRetrieveForeignPropertyService}
...
import v1.models.request.retrieveForeignProperty.{RetrieveForeignPropertyRawData, RetrieveForeignPropertyRequestData}
...
class RetrieveForeignPropertyControllerSpec
  extends ControllerBaseSpec
    with MockEnrolmentsAuthService
    with MockMtdIdLookupService
    with MockRetrieveForeignPropertyService
  ...
  trait Test {
    ...
    val controller = new RetrieveForeignPropertyController(
