...
import v1.mocks.requestParsers.foreignPropertyPeriodSummary.MockRetrieveForeignPropertyPeriodSummaryRequestParser
import v1.mocks.services.foreignPropertyPeriodSummary.MockRetrieveForeignPropertyPeriodSummaryService
import v1.mocks.services.{MockAuditService, MockEnrolmentsAuthService, MockMtdIdLookupService}
import v1.models.errors._
import v1.models.hateoas.Method.GET
import v1.models.hateoas.{HateoasWrapper, Link}
import v1.models.outcomes.ResponseWrapper
import v1.models.request.foreignPropertyPeriodSummary.retrieveForeignPropertyPeriodSummary.{RetrieveForeignPropertyPeriodSummaryRawData, RetrieveForeignPropertyPeriodSummaryRequestData}
import v1.models.response.foreignPropertyPeriodSummary.retrieveForeignPropertyPeriodSummary.foreignFhlEea.{ForeignFhlEea, ForeignFhlEeaExpenditure, ForeignFhlEeaIncome}
import v1.models.response.foreignPropertyPeriodSummary.retrieveForeignPropertyPeriodSummary.foreignProperty.{ForeignProperty, ForeignPropertyExpenditure, ForeignPropertyIncome, ForeignPropertyRentIncome}
import v1.models.response.foreignPropertyPeriodSummary.retrieveForeignPropertyPeriodSummary.{RetrieveForeignPropertyHateoasData, RetrieveForeignPropertyPeriodSummaryResponse}
