...
import v1.models.request.createForeignProperty.{ForeignFhlEeaExpenditure, ForeignPropertyExpenditure}
  ...
  "validate" when {
    "passed a foreignProperty Amend model" should {
      ...
      "return no errors" when {
        ...
        "passed an Create foreignFhlEea model" should {
          val consolidatedExpensesModel: ForeignFhlEeaExpenditure =
            ForeignFhlEeaExpenditure(None, None, None, None, None, None, None, Some(123.45))
