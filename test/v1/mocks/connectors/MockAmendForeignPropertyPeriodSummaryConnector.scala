...
import v1.connectors.{AmendForeignPropertyPeriodSummaryConnector, DownstreamOutcome}
...
trait MockAmendForeignPropertyPeriodSummaryConnector extends MockFactory {
  ...
  object MockAmendForeignPropertyConnector {
    ...
    def amendForeignProperty(requestData: AmendForeignPropertyPeriodSummaryRequest): CallHandler[Future[DownstreamOutcome[Unit]]] = {
