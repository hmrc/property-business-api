...
import v1.connectors.{DownstreamOutcome, RetrieveForeignPropertyPeriodSummaryConnector}
...
trait MockRetrieveForeignPropertyPeriodSummaryConnector extends MockFactory {
  ...
  object MockRetrieveForeignPropertyConnector {
    ...
    CallHandler[Future[DownstreamOutcome[RetrieveForeignPropertyPeriodSummaryResponse]]] = {
