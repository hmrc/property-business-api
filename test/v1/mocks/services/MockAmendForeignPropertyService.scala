...
import v1.services.AmendForeignPropertyService

import scala.concurrent.{ExecutionContext, Future}

trait MockAmendForeignPropertyService extends MockFactory {

  val mockService: AmendForeignPropertyService = mock[AmendForeignPropertyService]
