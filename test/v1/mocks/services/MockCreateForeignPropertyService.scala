...
import v1.services.CreateForeignPropertyService

import scala.concurrent.{ExecutionContext, Future}

trait MockCreateForeignPropertyService extends MockFactory {

  val mockCreateForeignPropertyService: CreateForeignPropertyService = mock[CreateForeignPropertyService]
