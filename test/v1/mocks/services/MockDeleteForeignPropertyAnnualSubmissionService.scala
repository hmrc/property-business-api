...
import v1.services.DeleteForeignPropertyAnnualSubmissionService
...
trait MockDeleteForeignPropertyAnnualSubmissionService extends MockFactory {
  ...
  object MockDeleteForeignPropertyAnnualSubmissionService {
    ...
    def createForeignProperty(requestData: DeleteForeignPropertyAnnualSubmissionRequest): CallHandler[Future[Either[ErrorWrapper, ResponseWrapper[Unit]]]] = {
      (mockDeleteForeignPropertyAnnualSubmissionService
        .deleteForeignPropertyAnnualSubmission(_: DeleteForeignPropertyAnnualSubmissionRequest)(_: HeaderCarrier, _: ExecutionContext, _: EndpointLogContext))
        .expects(requestData, *, *, *)
    }
  }
}
