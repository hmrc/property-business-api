...
package v1.models.response.foreignPropertyPeriodSummary.listForeignPropertiesPeriodSummaries
...
class ListForeignPropertiesPeriodSummariesResponseSpec extends UnitSpec with MockAppConfig {
  ...
  "Links Factory" should {
    ...
    "expose the correct top level links for list" in {
      ...
      ListForeignPropertiesPeriodSummariesResponse.LinksFactory.links(mockAppConfig, ListForeignPropertiesHateoasData(nino, businessId)) shouldBe
        Seq(
    ...
    "expose the correct item level links for list" in {
      MockedAppConfig.apiGatewayContext.returns("my/context").anyNumberOfTimes
      ListForeignPropertiesPeriodSummariesResponse.LinksFactory.itemLinks(mockAppConfig, ListForeignPropertiesHateoasData(nino, businessId),
