...
import v1.mocks.connectors.MockAmendForeignPropertyConnector
...
class AmendForeignPropertyServiceSpec extends UnitSpec {
  ...
  trait Test extends MockAmendForeignPropertyConnector {
