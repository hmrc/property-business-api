...
import v2.mocks.requestParsers.MockListForeignPropertiesPeriodSummariesRequestParser
import v2.mocks.services.{MockAuditService, MockEnrolmentsAuthService, MockListForeignPropertiesPeriodSummariesService, MockMtdIdLookupService}
...
import v2.models.hateoas.RelType.SELF
