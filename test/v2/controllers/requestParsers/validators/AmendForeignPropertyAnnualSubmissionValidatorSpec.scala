...
@Singleton
class AmendForeignPropertyAnnualSubmissionValidatorSpec extends UnitSpec with JsonErrorValidators with MockAppConfig {
  ...
  "running a validation" should {
    "return no errors" when {
      "a valid request is supplied" in {
        validator.validate(
          AmendForeignPropertyAnnualSubmissionRawData(nino = validNino, businessId = validBusinessId, taxYear = taxYear, body = body)) shouldBe Nil
      }

      "a valid propertyIncomeAllowance request is supplied" in {
        validator.validate(
          AmendForeignPropertyAnnualSubmissionRawData(nino = validNino,
    ...
    "return NinoFormatError error" when {
      "an invalid nino is supplied" in {
        validator.validate(
          AmendForeignPropertyAnnualSubmissionRawData(nino = "A12344A", businessId = validBusinessId, taxYear = taxYear, body = body)) shouldBe
    ...
    "return TaxYearFormatError" when {
      "an invalid tax year is supplied" in {
        validator.validate(AmendForeignPropertyAnnualSubmissionRawData(nino = validNino, businessId = validBusinessId, taxYear = "2020", body = body)) shouldBe
    ...
    "return RuleTaxYearNotSupportedError" when {
      "a tax year that is too early is supplied" in {
        validator.validate(
          AmendForeignPropertyAnnualSubmissionRawData(nino = validNino, businessId = validBusinessId, taxYear = "2020-21", body = body)) shouldBe
    ...
    "return RuleTaxYearRangeInvalidError" when {
      "a tax year range is more than 1 year" in {
        validator.validate(
          AmendForeignPropertyAnnualSubmissionRawData(nino = validNino, businessId = validBusinessId, taxYear = "2019-21", body = body)) shouldBe
    ...
    "return BusinessIdFormatError error" when {
      "an invalid businessId is supplied" in {
        validator.validate(AmendForeignPropertyAnnualSubmissionRawData(nino = validNino, businessId = "20178", taxYear = taxYear, body = body)) shouldBe
    ...
    "return RuleIncorrectOrEmptyBodyError" when {
      "an empty body is submitted" in {
        validator.validate(AmendForeignPropertyAnnualSubmissionRawData(nino = validNino,
                                                                       businessId = validBusinessId,
                                                                       taxYear = taxYear,
      ...
      "return multiple errors" when {
        "request supplied has multiple errors" in {
          validator.validate(AmendForeignPropertyAnnualSubmissionRawData(nino = "A12344A", businessId = "20178", taxYear = taxYear, body = body)) shouldBe
