...
class AmendHistoricFhlUkPeriodSummaryValidatorFactorySpec extends UnitSpec with MockAppConfig with JsonErrorValidators {
  ...
  private val parsedBody = AmendHistoricFhlUkPiePeriodSummaryRequestBody(
  ...
  private val validatorFactory = new AmendHistoricFhlUkPeriodSummaryValidatorFactory(mockAppConfig)
  ...
  "validator" should {
    "return the parsed domain object" when {
      "passed a valid request" in {
        ...
        result shouldBe Right(AmendHistoricFhlUkPiePeriodSummaryRequestData(parsedNino, parsedPeriodId, parsedBody))
      }
      ...
      "passed a valid consolidated request" in {
        ...
        result shouldBe Right(AmendHistoricFhlUkPiePeriodSummaryRequestData(parsedNino, parsedPeriodId, parsedBodyConsolidated))
      }
    }
