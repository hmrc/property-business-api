...
trait MockCreateHistoricFhlUkPiePeriodSummaryConnector extends MockFactory {
  ...
  val mockCreateHistoricFhlUkPiePropertyConnector: CreateHistoricFhlUkPiePeriodSummaryConnector = mock[CreateHistoricFhlUkPiePeriodSummaryConnector]

  object MockCreateHistoricFhlUkPiePeriodSummaryConnector {

    def createPropertyPeriodSummary(requestData: CreateHistoricFhlUkPiePeriodSummaryRequestData): CallHandler[Future[DownstreamOutcome[Unit]]] = {
      (
