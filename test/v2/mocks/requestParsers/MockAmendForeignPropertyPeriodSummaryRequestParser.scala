...
trait MockAmendForeignPropertyPeriodSummaryRequestParser extends MockFactory {
  ...
  val mockAmendForeignPropertyPeriodSummaryRequestParser: AmendForeignPropertyPeriodSummaryRequestParser =
    mock[AmendForeignPropertyPeriodSummaryRequestParser]
