...
trait MockCreateAmendForeignPropertyAnnualSubmissionRequestParser extends MockFactory {
  ...
  val mockCreateAmendForeignPropertyAnnualSubmissionRequestParser: CreateAmendForeignPropertyAnnualSubmissionRequestParser =
    mock[CreateAmendForeignPropertyAnnualSubmissionRequestParser]
