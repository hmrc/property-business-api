...
trait MockCreateAmendHistoricFhlUkPropertyAnnualSubmissionRequestParser extends MockFactory {
  ...
  val mockCreateAmendHistoricFhlUkPropertyAnnualSubmissionRequestParser: CreateAmendHistoricFhlUkPropertyAnnualSubmissionRequestParser =
    mock[CreateAmendHistoricFhlUkPropertyAnnualSubmissionRequestParser]
