...
trait MockCreateHistoricFhlUkPiePeriodSummaryRequestParser extends MockFactory {
  ...
  val mockCreateHistoricFhlUkPiePeriodSummaryRequestParser: CreateHistoricFhlUkPiePeriodSummaryRequestParser =
    mock[CreateHistoricFhlUkPiePeriodSummaryRequestParser]
