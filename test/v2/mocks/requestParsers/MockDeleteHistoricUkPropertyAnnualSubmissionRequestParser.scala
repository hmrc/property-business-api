...
trait MockDeleteHistoricUkPropertyAnnualSubmissionRequestParser extends MockFactory {
  ...
  val mockDeleteHistoricUkPropertyAnnualSubmissionRequestParser: DeleteHistoricUkPropertyAnnualSubmissionRequestParser =
    mock[DeleteHistoricUkPropertyAnnualSubmissionRequestParser]
