...
trait MockRetrieveHistoricNonFhlUkPropertyAnnualSubmissionRequestParser extends MockFactory {
  ...
  val mockRetrieveHistoricNonFhlUkPropertyAnnualSubmissionRequestParser: RetrieveHistoricNonFhlUkPropertyAnnualSubmissionRequestParser =
    mock[RetrieveHistoricNonFhlUkPropertyAnnualSubmissionRequestParser]
