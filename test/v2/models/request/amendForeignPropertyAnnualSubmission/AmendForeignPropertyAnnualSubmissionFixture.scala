...
import v2.models.request.amendForeignPropertyAnnualSubmission.foreignNonFhl.{ ForeignNonFhlAdjustments, ForeignNonFhlAllowances, ForeignNonFhlEntry }
import v2.models.request.common.StructuredBuildingAllowanceFixture

trait AmendForeignPropertyAnnualSubmissionFixture extends StructuredBuildingAllowanceFixture {
  ...
  val amendForeignPropertyAnnualSubmissionRequestBodyMtdJson: JsValue = Json.parse(s"""
      |{
  ...
  val amendForeignPropertyAnnualSubmissionRequestBodyDownstreamJson: JsValue = Json.parse(s"""
      |{
