...
class CreateHistoricFhlUkPropertyAnnualSubmissionRequestBodySpec extends UnitSpec {
  ...
  val requestBody: CreateHistoricFhlUkPropertyAnnualSubmissionRequestBody =
    CreateHistoricFhlUkPropertyAnnualSubmissionRequestBody(
      Some(
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        mtdJson.as[CreateHistoricFhlUkPropertyAnnualSubmissionRequestBody] shouldBe requestBody
      }
    }
  }
  "writes" when {
