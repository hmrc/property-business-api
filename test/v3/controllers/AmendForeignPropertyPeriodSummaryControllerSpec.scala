...
import v3.controllers.validators.MockAmendForeignPropertyPeriodSummaryValidatorFactory
import v3.models.request.amendForeignPropertyPeriodSummary._
import v3.models.request.common.foreignFhlEea.{AmendForeignFhlEea, AmendForeignFhlEeaExpenses, ForeignFhlEeaIncome}
...
import v3.services.MockAmendForeignPropertyPeriodSummaryService
  ...
  "AmendForeignPropertyPeriodSummaryController" should {
    "return a successful response with status 200 (OK)" when {
      "the request received is valid" in new Test {
        ...
        MockHateoasFactory
          .wrap((), AmendForeignPropertyPeriodSummaryHateoasData(validNino, businessId, taxYear, submissionId))
