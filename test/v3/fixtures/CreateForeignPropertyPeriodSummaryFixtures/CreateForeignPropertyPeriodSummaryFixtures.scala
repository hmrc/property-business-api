...
package v3.fixtures.CreateForeignPropertyPeriodSummaryFixtures

import play.api.libs.json.{JsValue, Json}
import v3.models.request.createForeignPropertyPeriodSummary.CreateForeignPropertyPeriodSummaryRequestBody
...
trait CreateForeignPropertyPeriodSummaryFixtures {
  ...
  private val regularForeignNonFhlProperty = Some(
    List(
      CreateForeignNonFhlPropertyEntry(countryCode = "FRA", income = foreignNonFhlPropertyIncome, expenses = regularForeignNonFhlPropertyExpenses)))
