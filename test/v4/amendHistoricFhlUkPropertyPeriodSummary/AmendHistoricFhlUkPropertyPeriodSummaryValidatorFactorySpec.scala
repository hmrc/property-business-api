...
import v4.amendHistoricFhlUkPropertyPeriodSummary.def1.model.Def1_AmendHistoricFhlUkPeriodSummaryValidator
  ...
  "validator()" when {
    "given any tax year" should {
      "return the Validator for schema definition 1" in {
        ...
        val result: Validator[AmendHistoricFhlUkPiePeriodSummaryRequestData] =
          validatorFactory.validator(validNino, validTaxYear, requestBody)
        result shouldBe a[Def1_AmendHistoricFhlUkPeriodSummaryValidator]
      }
    }
  }
