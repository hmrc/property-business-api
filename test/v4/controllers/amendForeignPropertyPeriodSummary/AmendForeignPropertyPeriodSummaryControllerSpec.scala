...
import v4.controllers.amendForeignPropertyPeriodSummary.def1.model.request.foreignFhlEea.{AmendForeignFhlEea, AmendForeignFhlEeaExpenses, ForeignFhlEeaIncome}
import v4.controllers.amendForeignPropertyPeriodSummary.def1.model.request.foreignPropertyEntry.{AmendForeignNonFhlPropertyEntry, AmendForeignNonFhlPropertyExpenses, ForeignNonFhlPropertyIncome, ForeignNonFhlPropertyRentIncome}
import v4.controllers.amendForeignPropertyPeriodSummary.model.request.{AmendForeignPropertyPeriodSummaryRequestData, Def1_AmendForeignPropertyPeriodSummaryRequestBody, Def1_AmendForeignPropertyPeriodSummaryRequestData}
import v4.controllers.amendForeignPropertyPeriodSummary.model.response.AmendForeignPropertyPeriodSummaryHateoasData
