...
import v4.controllers.amendForeignPropertyPeriodSummary.def1.model.request.foreignPropertyEntry.{ForeignNonFhlPropertyIncome, ForeignNonFhlPropertyRentIncome}
