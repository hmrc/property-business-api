...
import v4.controllers.createAmendUkPropertyAnnualSubmission.model.response.CreateAmendUkPropertyAnnualSubmissionHateoasData
import scala.concurrent.ExecutionContext.Implicits.global
import scala.concurrent.Future

class CreateCreateCreateAmendUkPropertyAnnualSubmissionControllerSpec
  ...
  trait Test extends ControllerTest with AuditEventChecking[GenericAuditDetail] {
    ...
    protected val hateoasData: CreateAmendUkPropertyAnnualSubmissionHateoasData =
      CreateAmendUkPropertyAnnualSubmissionHateoasData(nino, businessId, taxYear)
