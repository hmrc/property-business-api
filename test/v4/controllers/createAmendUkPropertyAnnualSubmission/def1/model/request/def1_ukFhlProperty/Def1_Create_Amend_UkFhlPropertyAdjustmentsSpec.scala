...
class Def1_Create_Amend_UkFhlPropertyAdjustmentsSpec extends UnitSpec {

  val requestBody: Def1_Create_Amend_UkFhlPropertyAdjustments =
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        validMtdJson.as[Def1_Create_Amend_UkFhlPropertyAdjustments] shouldBe requestBody
      }
    }
  }
