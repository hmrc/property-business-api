...
class Def1_Create_Amend_UkFhlPropertyAllowancesSpec extends UnitSpec {

  val requestBody: Def1_Create_Amend_UkFhlPropertyAllowances =
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        validMtdJson.as[Def1_Create_Amend_UkFhlPropertyAllowances] shouldBe requestBody
      }
    }
  }
