  ...
  "validator" should {
    "return the parsed domain object" when {
      "passed a valid request" in {
        ...
        result shouldBe Right(Def1_CreateUkPropertyPeriodSummaryRequestData(parsedNino, parsedTaxYear, parsedBusinessId, parsedBody))
      }
      ...
      "passed a valid request with a consolidated body" in {
        ...
        result shouldBe Right(Def1_CreateUkPropertyPeriodSummaryRequestData(parsedNino, parsedTaxYear, parsedBusinessId, parsedBodyConsolidated))
      }
      ...
      "passed a valid request with a minimal fhl body" in {
        ...
        result shouldBe Right(Def1_CreateUkPropertyPeriodSummaryRequestData(parsedNino, parsedTaxYear, parsedBusinessId, parsedBodyMinimalFhl))
      }
      ...
      "passed a valid request with a minimal non-fhl body" in {
        ...
        result shouldBe Right(Def1_CreateUkPropertyPeriodSummaryRequestData(parsedNino, parsedTaxYear, parsedBusinessId, parsedBodyMinimalNonFhl))
      }
      ...
      "passed the minimum supported taxYear" in {
        ...
        validator(validNino, taxYearString, validBusinessId, validBody).validateAndWrapResult() shouldBe
          Right(Def1_CreateUkPropertyPeriodSummaryRequestData(parsedNino, TaxYear.fromMtd(taxYearString), parsedBusinessId, parsedBody))
      }
    }
