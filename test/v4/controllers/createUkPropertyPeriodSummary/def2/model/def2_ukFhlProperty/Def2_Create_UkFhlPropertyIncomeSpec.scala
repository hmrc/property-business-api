...
package v4.controllers.createUkPropertyPeriodSummary.def2.model.def2_ukFhlProperty

import play.api.libs.json.Json
import support.UnitSpec
import v4.controllers.createUkPropertyPeriodSummary.def2.model.request.def2_ukFhlProperty.Def2_Create_UkFhlPropertyIncome
