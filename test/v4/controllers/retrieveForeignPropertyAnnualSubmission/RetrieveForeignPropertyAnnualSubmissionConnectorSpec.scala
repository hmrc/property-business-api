...
import v4.controllers.retrieveForeignPropertyAnnualSubmission.RetrieveForeignPropertyAnnualSubmissionConnector.{ForeignResult, NonForeignResult}
...
import v4.controllers.retrieveForeignPropertyAnnualSubmission.model.request.{
  Def1_RetrieveForeignPropertyAnnualSubmissionRequestData,
  RetrieveForeignPropertyAnnualSubmissionRequestData
}
import v4.controllers.retrieveForeignPropertyAnnualSubmission.model.response.{
