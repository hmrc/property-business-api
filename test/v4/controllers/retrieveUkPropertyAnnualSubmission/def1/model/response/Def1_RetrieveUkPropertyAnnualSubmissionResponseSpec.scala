...
package v4.controllers.retrieveUkPropertyAnnualSubmission.def1.model.response
...
import v4.controllers.retrieveUkPropertyAnnualSubmission.def1.model.response.def1_ukFhlProperty._
import v4.controllers.retrieveUkPropertyAnnualSubmission.def1.model.response.def1_ukNonFhlProperty._
  ...
  "LinksFactory" should {
    "produce the correct links" when {
      "called" in {
        ...
        RetrieveUkPropertyAnnualSubmissionResponse.RetrieveUkPropertyAnnualSubmissionLinksFactory.links(mockAppConfig, data) shouldBe Seq(
          Link(
