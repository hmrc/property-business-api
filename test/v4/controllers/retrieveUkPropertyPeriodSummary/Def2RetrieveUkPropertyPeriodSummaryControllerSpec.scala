...
import v4.controllers.retrieveUkPropertyPeriodSummary.def2.model.{Def2_RetrieveUkPropertyPeriodSummaryConsolidatedFixture, Def2_RetrieveUkPropertyPeriodSummaryFixture}
import v4.controllers.retrieveUkPropertyPeriodSummary.model.request._
import v4.controllers.retrieveUkPropertyPeriodSummary.model.response.{RetrieveUkPropertyPeriodSummaryHateoasData, RetrieveUkPropertyPeriodSummaryResponse}
