...
import v4.controllers.retrieveUkPropertyPeriodSummary.RetrieveUkPropertyPeriodSummaryConnector.Result
...
trait MockRetrieveUkPropertyPeriodSummaryConnector extends MockFactory {
  ...
  object MockRetrieveUkPropertyConnector {
    ...
    def retrieveUkProperty(requestData: RetrieveUkPropertyPeriodSummaryRequestData): CallHandler[Future[DownstreamOutcome[Result]]] = {
      (mockConnector
        .retrieveUkPropertyPeriodSummary(_: RetrieveUkPropertyPeriodSummaryRequestData)(_: HeaderCarrier, _: ExecutionContext, _: String))
        .expects(requestData, *, *, *)
    }
