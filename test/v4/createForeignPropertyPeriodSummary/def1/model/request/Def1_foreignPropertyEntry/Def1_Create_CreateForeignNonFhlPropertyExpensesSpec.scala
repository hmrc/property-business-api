...
class Def1_Create_CreateForeignNonFhlPropertyExpensesSpec extends UnitSpec {
  ...
  val model: Def1_Create_CreateForeignNonFhlPropertyExpenses = Def1_Create_CreateForeignNonFhlPropertyExpenses(
  ...
  "reads" should {
    "read from JSON" when {
      "valid JSON is provided" in {
        mtdJson.as[Def1_Create_CreateForeignNonFhlPropertyExpenses] shouldBe model
      }
    }
  }
