...
class Def2_Create_CreateForeignNonFhlPropertyExpensesSpec extends UnitSpec {
  ...
  val model: Def2_Create_CreateForeignNonFhlPropertyExpenses = Def2_Create_CreateForeignNonFhlPropertyExpenses(
  ...
  "reads" should {
    "read from JSON" when {
      "valid JSON is provided" in {
        mtdJson.as[Def2_Create_CreateForeignNonFhlPropertyExpenses] shouldBe model
      }
    }
  }
