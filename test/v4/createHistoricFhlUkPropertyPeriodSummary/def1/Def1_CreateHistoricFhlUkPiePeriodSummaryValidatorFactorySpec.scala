...
package v4.createHistoricFhlUkPropertyPeriodSummary.def1
...
import v4.createHistoricFhlUkPropertyPeriodSummary.CreateHistoricFhlUkPropertyPeriodSummaryValidatorFactory
...
class Def1_CreateHistoricFhlUkPiePeriodSummaryValidatorFactorySpec extends UnitSpec with JsonErrorValidators with MockAppConfig {
  ...
  "validator" should {
    "return the parsed domain object" when {
      "passed a valid request" in {
        ...
        result shouldBe Right(Def1_CreateHistoricFhlUkPiePeriodSummaryRequestData(parsedNino, parsedBody))
      }
      ...
      "passed a valid consolidated request" in {
        ...
        result shouldBe Right(Def1_CreateHistoricFhlUkPiePeriodSummaryRequestData(parsedNino, parsedBodyConsolidated))
      }
    }
