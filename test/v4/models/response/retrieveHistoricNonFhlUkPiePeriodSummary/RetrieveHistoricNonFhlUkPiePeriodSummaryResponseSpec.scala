...
package v4.models.response.retrieveHistoricNonFhlUkPiePeriodSummary
...
class RetrieveHistoricNonFhlUkPiePeriodSummaryResponseSpec extends UnitSpec with MockAppConfig {
  ...
  private val periodExpenses: PeriodExpenses =
    PeriodExpenses(
      decimal("5000.99"),
      decimal("4999.99"),
      decimal("4998.99"),
  ...
  private val model: RetrieveHistoricNonFhlUkPiePeriodSummaryResponse = RetrieveHistoricNonFhlUkPiePeriodSummaryResponse(
    fromDate = "2021-01-01",
    toDate = "2021-02-01",
    income = Some(
      periodIncome
  ...
  private val readsJson: JsValue = Json.parse("""{
                                        |   "from": "2021-01-01",
                                        |   "to": "2021-02-01",
                                        |   "financials": {
                                        |      "incomes": {
  ...
  private val writesJson: JsValue = Json.parse("""{
                                         |      "fromDate": "2021-01-01",
                                         |      "toDate": "2021-02-01",             
                                         |      "income": {
