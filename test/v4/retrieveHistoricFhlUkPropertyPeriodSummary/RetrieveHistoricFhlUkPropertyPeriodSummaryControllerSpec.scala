...
import v4.retrieveHistoricFhlUkPropertyPeriodSummary.def1.model.response.{PeriodExpenses, PeriodIncome, RentARoomExpenses, RentARoomIncome}
...
class RetrieveHistoricFhlUkPropertyPeriodSummaryControllerSpec
  ...
  trait Test extends ControllerTest {
    ...
    protected val requestData: RetrieveHistoricFhlUkPiePeriodSummaryRequestData =
      Def1_RetrieveHistoricFhlUkPiePeriodSummaryRequestData(Nino(nino), PeriodId(periodId))
    ...
    protected val responseData: RetrieveHistoricFhlUkPiePeriodSummaryResponse =
      Def1_RetrieveHistoricFhlUkPiePeriodSummaryResponse(
        fromDate = from,
        toDate = to,
        Some(periodIncome),
        Some(periodExpenses)
