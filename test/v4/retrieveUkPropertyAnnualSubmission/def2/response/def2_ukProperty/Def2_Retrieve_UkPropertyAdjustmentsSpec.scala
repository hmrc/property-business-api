...
import v4.retrieveUkPropertyAnnualSubmission.def2.model.response.def2_ukProperty.{Def2_Retrieve_UkPropertyAdjustments, Def2_Retrieve_UkPropertyRentARoom}

class Def2_Retrieve_UkPropertyAdjustmentsSpec extends UnitSpec {
  ...
  val model: Def2_Retrieve_UkPropertyAdjustments = Def2_Retrieve_UkPropertyAdjustments(
  ...
  "reads" should {
    "read JSON into a model" in {
      downstreamJson.as[Def2_Retrieve_UkPropertyAdjustments] shouldBe model
    }
  }
