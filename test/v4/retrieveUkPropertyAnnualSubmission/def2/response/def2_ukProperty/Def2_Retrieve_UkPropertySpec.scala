...
import v4.retrieveUkPropertyAnnualSubmission.def2.model.response.def2_ukProperty.{Def2_Retrieve_UkProperty, Def2_Retrieve_UkPropertyAdjustments, Def2_Retrieve_UkPropertyAllowances, Def2_Retrieve_UkPropertyBuilding, Def2_Retrieve_UkPropertyFirstYear, Def2_Retrieve_UkPropertyRentARoom, Def2_Retrieve_UkPropertyStructuredBuildingAllowance}

class Def2_Retrieve_UkPropertySpec extends UnitSpec {
  ...
  val model: Def2_Retrieve_UkProperty = Def2_Retrieve_UkProperty(
    adjustments = Some(
  ...
  "reads" should {
    "read JSON into a model" in {
      downstreamJson.as[Def2_Retrieve_UkProperty] shouldBe model
    }
  }
