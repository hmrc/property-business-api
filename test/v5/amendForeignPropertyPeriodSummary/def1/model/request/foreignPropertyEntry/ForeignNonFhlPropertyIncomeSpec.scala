...
package v5.amendForeignPropertyPeriodSummary.def1.model.request.foreignPropertyEntry

import play.api.libs.json.{JsValue, Json}
import shared.utils.UnitSpec
import v5.amendForeignPropertyPeriodSummary.def1.model.request.foreignPropertyEntry.{ForeignNonFhlPropertyIncome, ForeignNonFhlPropertyRentIncome}
