...
package v5.amendForeignPropertyPeriodSummary.def2.model.request.foreignPropertyEntry

import play.api.libs.json.{JsValue, Json}
import shared.utils.UnitSpec
import v5.amendForeignPropertyPeriodSummary.def2.model.request.def2_foreignPropertyEntry.Def2_AmendForeignNonFhlPropertyExpenses
