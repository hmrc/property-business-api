...
import v5.createAmendForeignPropertyAnnualSubmission.def1.model.request.def1_foreignNonFhl.{Def1_Create_Amend_Building, Def1_Create_Amend_FirstYear, Def1_Create_Amend_StructuredBuildingAllowance}
