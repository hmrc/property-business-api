...
class Def1_Create_Amend_UkPropertyAdjustmentsSpec extends UnitSpec {

  val requestBody: Def1_Create_Amend_UkPropertyAdjustments =
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        validMtdJson.as[Def1_Create_Amend_UkPropertyAdjustments] shouldBe requestBody
      }
    }
  }
