...
class CreateAmendUkFhlPropertySpec extends UnitSpec {

  val requestBody: CreateAmendUkFhlProperty =
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        validMtdJson.as[CreateAmendUkFhlProperty] shouldBe requestBody
      }
    }
  }
