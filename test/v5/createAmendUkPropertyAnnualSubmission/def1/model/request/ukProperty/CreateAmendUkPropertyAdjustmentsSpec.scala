...
class CreateAmendUkPropertyAdjustmentsSpec extends UnitSpec {

  val requestBody: CreateAmendUkPropertyAdjustments =
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        validMtdJson.as[CreateAmendUkPropertyAdjustments] shouldBe requestBody
      }
    }
  }
