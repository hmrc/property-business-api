...
class CreateForeignPropertyPeriodCumulativeSummaryRequestBodySpec extends UnitSpec with Def1_CreateForeignPropertyPeriodCumulativeSummaryFixtures {

  "reads" when {
    "passed valid JSON with regular expenses" should {
      "return a valid model" in {
        regularMtdRequestJson.as[Def1_CreateForeignPropertyPeriodCumulativeSummaryRequestBody] shouldBe regularExpensesRequestBody
      }
    }

    "passed valid JSON with consolidated expenses" should {
      "return a valid model" in {
        consolidatedMtdRequestJson.as[Def1_CreateForeignPropertyPeriodCumulativeSummaryRequestBody] shouldBe consolidatedExpensesRequestBody
      }
    }
  }
