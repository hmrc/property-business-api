...
class Def2_Create_ForeignNonFhlPropertyIncomeSpec extends UnitSpec {
  ...
  private val model = Def2_Create_ForeignNonFhlPropertyIncome(
  ...
  "reads" should {
    "read from JSON" when {
      "valid JSON is provided" in {
        mtdJson.as[Def2_Create_ForeignNonFhlPropertyIncome] shouldBe model
      }
    }
  }
