...
class AmendHistoricFhlUkPropertyPeriodSummaryServiceSpec extends UnitSpec {
  ...
  trait Test extends MockAmendHistoricFhlUkPropertyPeriodSummaryConnector {
    ...
    private val body: Def1_AmendHistoricFhlUkPropertyPeriodSummaryRequestBody =
    ...
    protected val request: Def1_AmendHistoricFhlUkPropertyPeriodSummaryRequestData =
      Def1_AmendHistoricFhlUkPropertyPeriodSummaryRequestData(Nino(nino), periodId, body)
