...
import v5.historicFhlUkPropertyPeriodSummary.list.def1.Def1_ListHistoricFhlUkPropertyPeriodSummariesValidator
...
class ListHistoricFhlUkPropertyPeriodSummariesValidatorFactorySpec extends UnitSpec {
  ...
  private val validatorFactory = new ListHistoricFhlUkPropertyPeriodSummariesValidatorFactory()
