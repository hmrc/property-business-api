...
import v5.historicFhlUkPropertyPeriodSummary.retrieve.def1.model.response.{PeriodExpenses, PeriodIncome, RentARoomExpenses, RentARoomIncome}
...
import v5.historicFhlUkPropertyPeriodSummary.retrieve.model.response.{
