...
import v5.retrieveForeignPropertyAnnualSubmission.def2.model.response.{RetrieveBuilding, RetrieveFirstYear, RetrieveStructuredBuildingAllowance}

class Def2_RetrieveStructuredBuildingAllowanceSpec extends UnitSpec {
