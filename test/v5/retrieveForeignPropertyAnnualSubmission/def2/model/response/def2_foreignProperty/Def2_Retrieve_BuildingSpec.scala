...
class Def2_Retrieve_BuildingSpec extends UnitSpec {

  val requestBody: Def2_Retrieve_Building =
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        validDownstreamJson.as[Def2_Retrieve_Building] shouldBe requestBody
        validDownstreamJson.as[Def2_Retrieve_Building] shouldBe requestBody
      }
    }
  }
