...
class Def2_Retrieve_ForeignPropertyAllowancesSpec extends UnitSpec {

  private val foreignPropertyAllowances = Def2_Retrieve_ForeignPropertyAllowances(
    Some(100.25),
    Some(100.25),
    Some(100.25),
    Some(100.25),
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        ifsJsonBody.as[Def2_Retrieve_ForeignPropertyAllowances] shouldBe foreignPropertyAllowances
      }
    }
  }
