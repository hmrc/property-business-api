...
class Def2_Retrieve_StructuredBuildingAllowanceSpec extends UnitSpec {

  val responseBody: Def2_Retrieve_StructuredBuildingAllowance =
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        validIfsJson.as[Def2_Retrieve_StructuredBuildingAllowance] shouldBe responseBody
      }
    }
  }
