...
trait MockRetrieveForeignPropertyCumulativeSummaryValidatorFactory extends MockValidatorFactory[RetrieveForeignPropertyCumulativeSummaryRequestData] {

  val mockRetrieveForeignPropertyCumulativeSummaryValidatorFactory: RetrieveForeignPropertyCumulativeSummaryValidatorFactory =
