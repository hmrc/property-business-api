...
import v5.retrieveForeignPropertyPeriodSummary.def1.model.response.foreignFhlEea.{ForeignFhlEea, ForeignFhlEeaExpenses, ForeignFhlEeaIncome}
import v5.retrieveForeignPropertyPeriodSummary.def1.model.response.foreignNonFhlProperty._
