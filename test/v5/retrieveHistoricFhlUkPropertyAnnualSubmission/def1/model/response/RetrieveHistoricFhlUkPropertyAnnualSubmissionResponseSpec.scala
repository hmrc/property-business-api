...
import v5.retrieveHistoricFhlUkPropertyAnnualSubmission.model.response.Def1_RetrieveHistoricFhlUkPropertyAnnualSubmissionResponse

class RetrieveHistoricFhlUkPropertyAnnualSubmissionResponseSpec extends UnitSpec {
