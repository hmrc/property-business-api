...
class Def1_Retrieve_UkPropertySpec extends UnitSpec {
  ...
  val model: Def1_Retrieve_UkProperty = Def1_Retrieve_UkProperty(
    adjustments = Some(
  ...
  "reads" should {
    "read JSON into a model" in {
      downstreamJson.as[Def1_Retrieve_UkProperty] shouldBe model
    }
  }
