...
import v5.retrieveUkPropertyCumulativeSummary.model.Result
...
trait MockRetrieveUkPropertyCumulativeSummaryConnector extends TestSuite with MockFactory {
  ...
  object MockRetrieveUkPropertyConnector {
    ...
    def retrieveUkProperty(requestData: RetrieveUkPropertyCumulativeSummaryRequestData): CallHandler[Future[DownstreamOutcome[Result]]] =
      (mockConnector
        .retrieveUkPropertyCumulativeSummary(_: RetrieveUkPropertyCumulativeSummaryRequestData)(_: HeaderCarrier, _: ExecutionContext, _: String))
        .expects(requestData, *, *, *)
