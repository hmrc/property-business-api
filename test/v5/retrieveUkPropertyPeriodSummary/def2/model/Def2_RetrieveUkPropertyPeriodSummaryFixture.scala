...
package v5.retrieveUkPropertyPeriodSummary.def2.model

import shared.models.domain.Timestamp
import play.api.libs.json.{JsValue, Json}
import v5.retrieveUkPropertyPeriodSummary.def2.model.response.*
import v5.retrieveUkPropertyPeriodSummary.model.response.*
...
trait Def2_RetrieveUkPropertyPeriodSummaryFixture {
  ...
  val fhlPropertyExpenses: Def2_Retrieve_FhlPropertyExpenses = Def2_Retrieve_FhlPropertyExpenses(
  ...
  val ukFhlProperty: Def2_Retrieve_UkFhlProperty = Def2_Retrieve_UkFhlProperty(
  ...
  val ukNonFhlExpenses: Def2_Retrieve_NonFhlPropertyExpenses = Def2_Retrieve_NonFhlPropertyExpenses(
  ...
  val ukNonFhlProperty: Def2_Retrieve_UkNonFhlProperty = Def2_Retrieve_UkNonFhlProperty(
    income = Some(ukNonFhlIncome),
    expenses = Some(ukNonFhlExpenses)
  )

  val fullResponse: Def2_RetrieveUkPropertyPeriodSummaryResponse = Def2_RetrieveUkPropertyPeriodSummaryResponse(
