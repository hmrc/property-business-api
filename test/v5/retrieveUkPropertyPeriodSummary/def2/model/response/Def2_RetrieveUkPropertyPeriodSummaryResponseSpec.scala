...
class Def2_RetrieveUkPropertyPeriodSummaryResponseSpec extends UnitSpec with Def1_RetrieveUkPropertyPeriodSummaryFixture {
  private val downstreamJson: JsValue = fullDownstreamJson
  private val mtdJson: JsValue        = fullMtdJson

  "RetrieveUkPropertyPeriodSummaryResponse" when {
    "read from downstream JSON" should {
      "create the parsed object" in {
        val result = downstreamJson.as[Def1_RetrieveUkPropertyPeriodSummaryResponse]
