...
class CreateAmendUkFhlPropertyAllowancesSpec extends UnitSpec {

  val requestBody: CreateAmendUkFhlPropertyAllowances =
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        validMtdJson.as[CreateAmendUkFhlPropertyAllowances] shouldBe requestBody
      }
    }
  }
