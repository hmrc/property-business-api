...
class Def3_CreateAmendUkPropertyAnnualSubmissionRequestBodySpec extends UnitSpec {

  val requestBody: Def3_CreateAmendUkPropertyAnnualSubmissionRequestBody =
  ...
  "reads" when {
    "passed a valid JSON" should {
      "return a valid model" in {
        validMtdJson.as[Def3_CreateAmendUkPropertyAnnualSubmissionRequestBody] shouldBe requestBody
      }
    }
  }
