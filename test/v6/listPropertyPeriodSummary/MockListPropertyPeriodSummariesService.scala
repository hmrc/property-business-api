...
trait MockListPropertyPeriodSummariesService extends TestSuite with MockFactory {
  ...
  object MockListPropertyPeriodSummariesService {
    ...
    def listPeriodSummaries(
        requestData: ListPropertyPeriodSummariesRequestData
    ): CallHandler[Future[ServiceOutcome[ListPropertyPeriodSummariesResponse]]] = {
