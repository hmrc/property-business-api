...
trait MockRetrieveForeignPropertyDetailsService extends TestSuite with MockFactory {

  val mockRetrieveForeignPropertyDetailsService: RetrieveForeignPropertyDetailsService = mock[RetrieveForeignPropertyDetailsService]

  object MockRetrieveForeignPropertyDetailsService {
