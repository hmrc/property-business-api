...
class Def1_RetrieveForeignPropertyPeriodSummaryValidatorSpec extends UnitSpec {
  ...
  private def validator(nino: String, businessId: String, taxYear: String, submissionId: String, maxTaxYear: TaxYear = maxTaxYear) =
    new Def1_RetrieveForeignPropertyPeriodSummaryValidator(nino, businessId, taxYear, maxTaxYear, submissionId)
