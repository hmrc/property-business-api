...
class RetrieveUkFhlPropertySpec extends UnitSpec {
  ...
  val model: RetrieveUkFhlProperty = RetrieveUkFhlProperty(
    adjustments = Some(
  ...
  "reads" should {
    "read JSON into a model" in {
      downstreamJson.as[RetrieveUkFhlProperty] shouldBe model
    }
  }
