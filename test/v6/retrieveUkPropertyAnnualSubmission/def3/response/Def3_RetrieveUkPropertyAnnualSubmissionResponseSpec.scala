...
package v6.retrieveUkPropertyAnnualSubmission.def3.response
...
class Def3_RetrieveUkPropertyAnnualSubmissionResponseSpec extends UnitSpec {
  ...
  private val parsed = Def3_RetrieveUkPropertyAnnualSubmissionResponse(
  ...
  "reads" should {
    "read tys JSON into a model" in {
      val result = tysDownstreamJson.as[Def3_RetrieveUkPropertyAnnualSubmissionResponse]
